 ...
 * ``holder'' classes (e.g., {@link DoubleHolder DoubleHolder},
 * {@link StringHolder StringHolder}, etc.).
 *
 ...
 * DoubleHolder DoubleHolder} or {@link StringHolder
 ...
 * </pre>
 *
 * will create three instances of {@link DoubleHolder DoubleHolder},
...
//	      this.closed = closed;
    ...
    class RangeAtom {
        ...
        public String toString() {
            return "low=" + (low == null ? "null" : low.toString()) + ", high=" + (high == null ? "null" : high.toString());
        }
    }
    ...
    class Record {
        ...
        void scanValue(Object result, String name, String s, int resultIdx) throws ArgParseException {
            ...
            try {
                ...
                throw new ArgParseException(name, "malformed " + valTypeName() + " '" + s + "'");
            }
            ...
            if (outOfRange) {
                ...
                throw new ArgParseException(name, "value '" + s + "' not in range " + rangeDesc);
            }
...
//  	 }
     ...
     * <code>%o</code></td>
     * <td>{@link IntHolder IntHolder},
     * {@link LongHolder LongHolder}, <code>int[]</code>, or
     * <code>long[]</code></td>
     * </tr>
     *
     * <tr valign=top>
     * <td><code>%f</code></td>
     * <td>{@link FloatHolder FloatHolder},
     * {@link DoubleHolder DoubleHolder},
     * <code>float[]</code>, or
     * <code>double[]</code></td>
     * </tr>
     *
     ...
     * <td>{@link BooleanHolder BooleanHolder} or
     * <code>boolean[]</code></td>
     * </tr>
     *
     * <tr valign=top>
     * <td><code>%s</code></td>
     * <td>{@link StringHolder StringHolder} or
     * <code>String[]</code></td>
     * </tr>
     *
     * <tr valign=top>
     * <td><code>%c</code></td>
     * <td>{@link CharHolder CharHolder} or
     * <code>char[]</code></td>
     * </tr>
     * </table>
     *
     ...
     * <td><code>%i</code>, <code>%d</code>, <code>%x</code>,
     * <code>%o</code></td>
     * <td>{@link LongHolder LongHolder}, or
     * <code>long[]</code> if the multiplier value exceeds 1</td>
     * </tr>
     *
     * <tr valign=top>
     * <td><code>%f</code></td>
     * <td>{@link DoubleHolder DoubleHolder}, or
     ...
     * <tr valign=top>
     * <td><code>%c</code></td>
     * <td>{@link CharHolder CharHolder}, or <code>char[]</code>
     * if the multiplier value exceeds 1</td>
     * </tr>
     * </table>
     *
...
//  	       }
     ...
     * an {@link ArgParseException ArgParseException}
